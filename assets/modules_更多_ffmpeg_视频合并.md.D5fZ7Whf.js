import{_ as a,c as s,o as n,a4 as p}from"./chunks/framework.BX6rvgvq.js";const _=JSON.parse('{"title":"视频合并","description":"","frontmatter":{},"headers":[],"relativePath":"modules/更多/ffmpeg/视频合并.md","filePath":"modules/更多/ffmpeg/视频合并.md","lastUpdated":1773858860000}'),e={name:"modules/更多/ffmpeg/视频合并.md"},t=p(`<h1 id="视频合并" tabindex="-1">视频合并 <a class="header-anchor" href="#视频合并" aria-label="Permalink to &quot;视频合并&quot;">​</a></h1><h2 id="淡出淡入" tabindex="-1">淡出淡入 <a class="header-anchor" href="#淡出淡入" aria-label="Permalink to &quot;淡出淡入&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>ffmpeg -i input1.mp4 -i input2.mp4 -filter_complex &quot;[0:v][1:v]xfade=transition=fade:duration=1:offset=4[video];[0:a][1:a]acrossfade=d=1[audio]&quot; -map &quot;[video]&quot; -map &quot;[audio]&quot; output.mp4</span></span>
...
<span class="line"><span>调整st（开始时间）和d（持续时间）以匹配视频实际时长。</span></span></code></pre></div>`,3),i=[t];function l(o,d,c,u,f,r){return n(),s("div",null,i)}const h=a(e,[["render",l]]);export{_ as __pageData,h as default};
