import{_ as a,c as s,o as n,a4 as e}from"./chunks/framework.BX6rvgvq.js";const v=JSON.parse('{"title":"JS 字符串与二进制的相互转化","description":"","frontmatter":{},"headers":[],"relativePath":"modules/javascript/JS字符串与二进制的相互转化.md","filePath":"modules/javascript/JS字符串与二进制的相互转化.md","lastUpdated":1745220936000}'),p={name:"modules/javascript/JS字符串与二进制的相互转化.md"},t=e(`<h1 id="js-字符串与二进制的相互转化" tabindex="-1">JS 字符串与二进制的相互转化 <a class="header-anchor" href="#js-字符串与二进制的相互转化" aria-label="Permalink to &quot;JS 字符串与二进制的相互转化&quot;">​</a></h1><ul><li>字符串转 ascii 码，用 charCodeAt();</li><li>ascii 码转字符串，用 fromCharCode();</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>var str = &quot;A&quot;;</span></span>
