import{_ as s,c as a,o as n,a2 as p}from"./chunks/framework.Ps2l0eYJ.js";const v=JSON.parse('{"title":"不使用脚手架创建 vue 项目","description":"","frontmatter":{},"headers":[],"relativePath":"modules/vue/不使用脚手架创建vue项目.md","filePath":"modules/vue/不使用脚手架创建vue项目.md"}'),e={name:"modules/vue/不使用脚手架创建vue项目.md"},l=p(`<h1 id="不使用脚手架创建-vue-项目" tabindex="-1">不使用脚手架创建 vue 项目 <a class="header-anchor" href="#不使用脚手架创建-vue-项目" aria-label="Permalink to &quot;不使用脚手架创建 vue 项目&quot;">​</a></h1><h3 id="_1-初始化项目文件夹-生成配置文件" tabindex="-1">1. 初始化项目文件夹，生成配置文件 <a class="header-anchor" href="#_1-初始化项目文件夹-生成配置文件" aria-label="Permalink to &quot;1. 初始化项目文件夹，生成配置文件&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm init -y</span></span></code></pre></div><h3 id="_2-安装相关依赖" tabindex="-1">2. 安装相关依赖 <a class="header-anchor" href="#_2-安装相关依赖" aria-label="Permalink to &quot;2. 安装相关依赖&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm i webpack webpack-cli html-webpack-plugin webpack-dev-server -D</span></span>
