...
<span class="line"><span>a=fmtp:96 profile-level-id=1</span></span></code></pre></div><p>SDP保存到文件，这样VLC就可以通过这个sdp文件播放上面的视频</p>`,8),l=[t];function i(c,o,r,d,h,m){return n(),s("div",null,l)}const _=a(e,[["render",i]]);export{g as __pageData,_ as default};
